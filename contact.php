    ...
    <header>
      <div class="container">
        <div class="intro-text">
          ...
          <a href="#team" class="page-scroll btn btn-xl">Suivre</a>
        </div>
      </div>
    </header>
      ...
      <div class="container">
          <div class="row">
              <div class="col-lg-12 text-center">
                  <h2 class="section-heading">Notre magnifique equipe</h2>
          ...
          <div class="row">
            <div class="col-sm-4">
                <div class="team-member">
                    ...
                    <h4>Junk0</h4>
                    <p class="text-muted">Moderateur</p>
            ...
            <div class="col-sm-4">
                <div class="team-member">
                    ...
                    <h4>ToeiAzarothis</h4>
                    <p class="text-muted">Web Developpeur</p>
                    <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-comment-o"></i></a></li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">Les guildes de notre communauté</h2>
                <h3 class="section-subheading text-muted">.</h3>
            </div>
        </div>
        <div class="row">
