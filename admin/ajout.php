              ...
              <div class="well">
                <form class="form-horizontal" role="form" method="post" action="traitement.php">
                	<div class="form-group">
                		<label for="name" class="col-sm-2 control-label">Inconnu</label>
                		<div class="col-sm-10">
                			<input type="text" class="form-control" id="Inconnu" name="Inconnu" placeholder="Inconnu" value="" required="">
                		</div>
                	</div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                	...
                	<div class="form-group">
                		...
                		<div class="col-sm-10">
                			<!-- <input type="email" class="form-control" id="Rang_special" name="Rang_special"
                       placeholder="Rang particulier" value="" required=""> -->
                  ...
                  <div class="form-group">
                		...
                		<div class="col-sm-10">
                			<input type="text" class="form-control" id="Informations_Sup" name="Informations_Sup" placeholder="Informations Supplementaire" value="" required="">
                		</div>
                	</div>
                	<div class="form-group">
